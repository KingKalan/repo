...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]KingKalan[/B][/COLOR]Wizard'
BUILDERNAME = 'KingKalan'
EXCLUDES = [ADDON_ID, 'repository.KingKalan']
# Text File with build info in it. Please read https://github.com/a4k-KingKalanproject/plugin.program.KingKalan/wiki/Installing-Builds
BUILDFILE = 'http://'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]KingKalan[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing KingKalan.\n\nContact us on at https://raw.githubusercontent.com/KingKalan/repo/main/'
...
REPOID = 'repository.KingKalan'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/KingKalan/repo/main/matrix/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/KingKalan/repo/main/matrix/zips/repository.KingKalan'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]KingKalan[/B][/COLOR]Wizard'
